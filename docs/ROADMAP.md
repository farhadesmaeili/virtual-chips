...
> ادامه‌ی Phase 4 (تسک‌های 4.7–4.9). این بخش از تست دستیِ بعد از 4.3 بیرون آمد:
> چون **خود بازی دستی است** (بدون hand evaluation، کارت‌های فیزیکی)، pace را
> انسان کنترل می‌کند نه موتور.
