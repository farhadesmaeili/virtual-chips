...
const hand: PublicHandState = {
  ...
  status: 'betting',
  players: [
    { seat: 0, stack: 3400, committedThisStreet: 20, committedTotal: 20, state: 'active', hasActedThisStreet: false, lastAction: null, timeExtensionsRemaining: 2 }, // prettier-ignore
    { seat: 1, stack: 2120, committedThisStreet: 40, committedTotal: 40, state: 'active', hasActedThisStreet: true, lastAction: 'RAISE', timeExtensionsRemaining: 2 }, // prettier-ignore
    { seat: 2, stack: 980, committedThisStreet: 0, committedTotal: 0, state: 'folded', hasActedThisStreet: true, lastAction: 'FOLD', timeExtensionsRemaining: 2 }, // prettier-ignore
    { seat: 4, stack: 0, committedThisStreet: 200, committedTotal: 200, state: 'all_in', hasActedThisStreet: true, lastAction: 'ALL_IN', timeExtensionsRemaining: 2 }, // prettier-ignore
    { seat: 5, stack: 0, committedThisStreet: 0, committedTotal: 0, state: 'sitting_out', hasActedThisStreet: false, lastAction: null, timeExtensionsRemaining: 2 }, // prettier-ignore
    { seat: 7, stack: 1750, committedThisStreet: 40, committedTotal: 40, state: 'active', hasActedThisStreet: true, lastAction: 'CALL', timeExtensionsRemaining: 2 }, // prettier-ignore
  ],
